...
The winner index for the conditions of Attacker calling select winner, duration+1 amount of time has passed, with 4 players: 1

The rarity the Attacker will receive is: 25

Balance of attacker before winner is selected: 0

Balance of attacker after winner is selected: 3200000000000000000
...
**Description:** Consider using a specified version instead of a wide version.

**Mitigation**

Remove the floating pragma character
